...
from core.load_data import load_dataframe
from core.task_1 import fig_task_1

covid19_data_frame_all = load_dataframe(from_url = False)
...
covid19_data_frame = covid19_data_frame_all.loc[covid19_data_frame_all['continent'] == 'Europe']  
...
def render_content(tab):
    if tab == 'tab-1':
        # fig1 = fig_task_1(country = ["India", "Ukraine"], continent = "", COVID_df = covid19_data_frame_all)
